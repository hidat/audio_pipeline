...
def find_meta_release(mbid, tracknum, discnum, cached_releases):
    """
    ...
    release_info["disc_count"] = len(release["medium-list"])
    ...
    release_info["artist-credit"] = release['artist-credit']
    ...
    track = release["medium-list"][disc_index]["track-list"][tracknum]
    track_info = {}
    track_info["track_num"] = tracknum
    track_info["track_count"] = len(release["medium-list"][disc_index]["track-list"])
