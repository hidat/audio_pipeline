...
t1_tags = {'tracktotal': 12, 'album': 'Who Killed...... The Zutons?',
           ...
           'genre': 'Rock', 'mbid': '5560ffa9-3824-44f4-b2bf-a96ae4864187', 'length': '3:32'}
...
picard_tags = {'tracknumber': 6, 'totaltracks': 13, 'encoded by': 'dBpoweramp Release 14.4', 
           ...
           'encoder settings': '-compression-level-5', 'originalyear': '2012', 'length': '3:48'}   
...
unknown_tags = {'accurateripresult': 'AccurateRip: Not in database   7A470C62', 
                ...
                'title': 'Track04', 'tracknumber': 4, 'discnumber': 1, 'length': '0:49'}                
...
class TestReadGenericTagsID3(TestReadGenericTags):
    # unfortunately, ID3 sometimes has a different release date format
    def test_release_date(self):
        tag = self.format.release_date(self.meta)
        self.check_tag(tag, self.tags, "date2")
...
class TestReadGenericTagsID3_t1(TestReadGenericTagsID3, unittest.TestCase):
    def setUp(self):
